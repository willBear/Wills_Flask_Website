...
class UserModelCase(unittest.TestCase):
    def setUp(self):
        # We implement a a little hack in setUp(), to prevent units from using
        # the regular database that we use for development. By changing the
        # application configuration to sqlite://, SQLAlchemy use an in-memory SQLite
